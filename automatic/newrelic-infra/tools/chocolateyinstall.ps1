...
$url64      = 'https://download.newrelic.com/infrastructure_agent/windows/newrelic-infra.1.11.45.msi'
...
$packageArgs = @{
  ...
  checksum64     = '9447a8afa219bf1dca32c66df6b5ad743933ce9b1bfabfcd3698bcf8bc55864e'
