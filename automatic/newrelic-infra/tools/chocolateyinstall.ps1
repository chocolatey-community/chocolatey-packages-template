...
$url64      = 'https://download.newrelic.com/infrastructure_agent/windows/newrelic-infra.1.42.5.msi'
...
$packageArgs = @{
  ...
  checksum64     = '0d47d65185722158a966c81d1af63c7a561242b82537154c6d26a08588a9c79d'
