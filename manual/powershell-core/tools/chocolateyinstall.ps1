...
$packageArgs = @{
  ...
  fileType      = $fileType
  url64      = 'https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/PowerShell-7.2.6-win-x64.msi'
  checksum64    = '77566d5b831523c6740c392b64237c52089b574f342a9f51d84aded24e412cb8'
  checksumType64= 'sha256'
  url           = 'https://github.com/PowerShell/PowerShell/releases/download/v7.2.6/PowerShell-7.2.6-win-x86.msi'
  checksum      = 'cc6c3b8eeca872c27ef4b42c3cdeb49652112f6cde72e16d7006f073e543936d'
