...
$global:au_GalleryUrl   = "https://pkgs.dev.azure.com/EnsembleHealth/EHIF-ITOps/_packaging/ITOps-WVD-Patching/nuget/v3"             #URL to package gallery, leave empty for Chocolatey Gallery
